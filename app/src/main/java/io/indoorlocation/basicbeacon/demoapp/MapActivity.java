...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoiZGxjc3VuIiwiYSI6ImNrMzR3cTM4MjFhMjgzaHBwaHd2dmluNXAifQ.3MO86ysxIihP0sp3sFz0Fg");// PASTE YOU MAPBOX API KEY HERE !!! This is a demo key. It is not allowed to use it for production. The key might change at any time without notice. Get your key by signing up at mapbox.com
    ...
    private void setupLocationProvider() {
        ...
        basicBeaconIndoorLocationProvider = new BasicBeaconIndoorLocationProvider(this, "3e0fc9b21a9eaa48350a1c0513cfdef6", gpsIndoorLocationProvider);
